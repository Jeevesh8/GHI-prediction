...
class ar_nt(nn.Module) :
    def __init__(self, seq_len, ini_len = 18) :
        super().__init__()
        self.d_model = 20
        ...
        self.final = nn.Sequential(nn.Linear(self.d_model*self.seq_len,512),nn.ReLU(), nn.Linear(512,256),nn.ReLU(),nn.Linear(256,1))
